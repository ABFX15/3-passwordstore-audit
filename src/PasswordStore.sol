...
contract PasswordStore {
    ...
    // @audit the s_password variable is not actaully private! this is not a safe place to secure your password!
    ...
    // q should a non-owner be able to set a new password? 
